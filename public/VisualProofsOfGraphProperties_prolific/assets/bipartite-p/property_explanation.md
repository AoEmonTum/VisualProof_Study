...
<div class="study-shell">
  <div class="study-hero">
    ...
    <div class="study-figure">
      ...
      <img src="VisualProofsOfGraphProperties_prolific/assets/bipartite-p/graphs/tutorial_graph_001_proof_property.png" alt="Example of a bipartite network">
    </div>
    <div class="study-figure">
          ...
          <div style="display: flex; justify-content: center; gap: 24px; align-items: center; margin-top: 16px;">
                <img style="width: calc(50% - 12px); height: auto; display: block;" src="VisualProofsOfGraphProperties_prolific/assets/bipartite-p/graphs/tutorial_graph_001_proof_noproperty.png" alt="Network uncolored">
                <img style="width: calc(50% - 12px); height: auto; display: block;" src="VisualProofsOfGraphProperties_prolific/assets/bipartite-p/graphs/tutorial_graph_001_noproof_property.png" alt="Network colored">
            </div>
        </div>
    <div class="study-figure">
      ...
      <img src="VisualProofsOfGraphProperties_prolific/assets/bipartite-p/graphs/tutorial_graph_001_noproof_noproperty.png" alt="Example of a network that is not bipartite">
    </div>
  </div>
</div>
