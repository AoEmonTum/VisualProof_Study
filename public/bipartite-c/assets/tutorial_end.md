...
<div style="max-width: 760px; margin: 40px auto; padding: 32px; border: 1px solid #dce7f5; border-radius: 24px; background: linear-gradient(135deg, #f7fbff 0%, #eef4ff 100%); color: #1f2937; box-shadow: 0 16px 36px rgba(15, 23, 42, 0.06);">
  ...
  <p style="margin: 0; font-size: 17px; line-height: 1.8; color: #354255;">The four graphs you just completed were a tutorial. The actual bipartite study starts now. Remember: from now on there will be a time limit for each graph.</p>
</div>
