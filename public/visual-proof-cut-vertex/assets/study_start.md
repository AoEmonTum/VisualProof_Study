...
The cut vertex Section
</h1>

<p style="font-size:18px; line-height:1.7; color:#555; margin-bottom:30px;">
You are now about to begin the <strong>cut vertex</strong> part of the study.
...
<ul style="font-size:17px; line-height:1.9; padding-left:22px; margin-bottom:0;">
<li>Each graph will be displayed for <strong>6 seconds</strong>.</li>
