...
STUDY_ID = "visual-proof-study-pilot-4"
STUDY_DIR = PUBLIC_DIR / STUDY_ID
ASSETS_DIR = STUDY_DIR / "assets"
GLOBAL_CONFIG_PATH = PUBLIC_DIR / "global.json"
PROPERTY_STUDIES = (
    ("bipartite-study-7", "bipartite-study-7"),
    ("hamiltonian-cycle-study-7", "hamiltonian-cycle-study-7"),
    ("cut-vertex-study-7", "cut-vertex-study-7"),
)
