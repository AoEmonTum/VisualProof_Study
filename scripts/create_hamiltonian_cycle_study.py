...
STUDY_ID = "hamiltonian-cycle-component"


def write_intro(assets_dir: Path, study_id: str, tutorial: dict[str, dict]) -> None:
    """Write the Hamiltonian-cycle-specific section introduction."""
...
if __name__ == "__main__":
    create_study(
        ...
        StudySettings(
            ...
            property_definition="A Hamiltonian cycle is a closed path that visits every node exactly once and returns to its starting node.",
            verification_prompt="Based on this visualization, does this graph contain a Hamiltonian cycle?",
